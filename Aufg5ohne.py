...
# print what we got:
zeit=data_array[:,0] # 1st column
omega=data_array[:,1] # 2nd column

praefreq=2*np.pi/zeit
...
generate_datasets('Aufg5ohnek.dat')

# Initialize Dataset
my_datasets = [kafe.Dataset(title="Zeit")]
# Load the Dataset from the file
my_datasets[0].read_from_file(input_file='Aufg5ohnek.dat')
...
#Verschoenern
my_plot.axis_labels = ['$1/\omega$ (1/s)', '$\omega_{p}$ (s)']
